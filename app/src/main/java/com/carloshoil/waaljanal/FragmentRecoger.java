 ...
 * Use the {@link FragmentRecoger#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentRecoger extends Fragment {
     ...
     * @return A new instance of fragment FragmentRecoger.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentRecoger newInstance(String param1, String param2) {
        FragmentRecoger fragment = new FragmentRecoger();
    ...
    public void onPause() {
        RemueveListener();
        Log.d("DEBUGX", "Fragment Recoger- onPause");
        super.onPause();
    }
    ...
    public void onResume() {
        AgregaListener();
        Log.d("DEBUGX", "Fragment Recoger- onResume");
        super.onResume();
    }
    ...
    @Override
    public void onStop() {
        Log.d("DEBUGX", "Fragment Recoger- onStop");
        super.onStop();
    }

    @Override
    public void onDestroy() {
        Log.d("DEBUGX", "Fragment Recoger- onDestroy");
        super.onDestroy();
    }
    private void RemueveListener()
    {
    ...
    private void PreparaAdapter()
    {
        ...
        adapterPedidos = new AdapterPedidos(getActivity(), new ArrayList<>(), "recoger");
        recyclerView.setAdapter(adapterPedidos);
    }
    private void Init(View view)
    {
        recyclerView=view.findViewById(R.id.recycleViewRecoger);
        ckTomados=view.findViewById(R.id.ckTomadosRecoger);
        ckTomados.setOnCheckedChangeListener((compoundButton, b) -> {
            if(b)
            {
                //databaseReferenceTomados= firebaseDatabase.getReference().child("pedidos").child(cIdMenu).child("recoger").child("tomados");
            }
        });
        PreparaAdapter();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("DEBUGX", "seCrea- FragmentRecoger");
        View view= inflater.inflate(R.layout.fragment_recoger, container, false);
        Init(view);
        return view;
    }
